...
\begin{tikzpicture}	
	...
	\node[point] (input) [left = 2em of block1_1] {$ u $};
	\draw[vec] (input) to (block1_1);

	\mysum{right = 1em of block1_1}{sum1_1};
	\draw[vec] (block1_1) to (sum1_1);

	\node[block] (block1_2)[right = 8em of block1_1] {$\in$};	
	\draw[vec] (sum1_1) to (block1_2);
		
	\node[block] (block1_3)[below = 1em of block1_2] {$A$};
	\node[point] (LineSeparator1_2) [right = 3em of block1_2]{}; 	
	\fill (LineSeparator1_2) circle (1pt);	
	\node[point] (LineSeparator1_3) [above right = 0.1em of LineSeparator1_2]{$x$}; 	
	
	\node[point] (LineSeparator1_3) [right = 3em of block1_3]{}; 		
	\draw (LineSeparator1_2) |- (LineSeparator1_3) [vec] to (block1_3);
	
	
	\node[point] (LineSeparator1_4) [left = 6em of block1_3]{}; 	
	\draw (block1_3) |- (LineSeparator1_4) [vec] to (sum1_1);
	
		
	\node[block] (block1_4)[right = 6em of block1_2] {$\mathbb{C}$};	
	...
	%Bottom row
	\node[block] (block2_1) [below = 8.5em of input_int] {$ B $};
	\node[point] (LineSeparator1_1) 	 [left = 1em of block1_1] {};
	\fill (LineSeparator1_1) circle (1pt);
	
	\node[point] (LineSeparator2_1) 	 [left = 1em of block2_1] {};
