...
\begin{enumerate}
\item $ S_\varphi ( \omega ) = \frac{1}{ \omega ^2 + 1 } + c^2 = \frac{ c^2 \omega ^2 + c^2 + 1 }{ \omega ^2 + 1 } $
\item $ S_\varphi ( \omega ) = \underbrace{ \frac{ jc\omega + \sqrt{ 1 + c^2 } }{ j\omega + 1 } }_{ \psi ( j\omega ) } \cdot \underbrace{ \frac{ -jc\omega + \sqrt{ 1 + c^2 } }{ -j\omega + 1 } }_{ \psi ( -j\omega ) } $
\[ \psi (p) = \frac{ cp + \sqrt{ 1 + c^2 } }{ 1 + p } \]
\item $ N ( j\omega ) = S_v ( \omega ) \cdot \psi ^{-1} ( -j\omega ) = \frac{1}{ \omega ^2 + 1 } \cdot \frac{ -j\omega + 1 }{ -jc\omega + \sqrt{ 1 + c^2 } } = \frac{1}{ ( 1 + j\omega ) \Bigl( \sqrt{ 1 + c^2 } - jc\omega \Bigr) } $
\[ N(p) = \frac{1}{ (1+p) \Bigl( \sqrt{ c^2 + 1 } - cp \Bigr) } \]
\item $ N(p) = \frac{1}{ (1+p) \Bigl( \sqrt{ 1 + c^2 } - cp \Bigr) } = $ \par
\begin{flushright} \vspace{-\baselineskip}
$ \frac{1}{ c + \sqrt{ 1 + c^2 } } \cdot \left( \frac{1}{1+p} + \frac{c}{ \sqrt{ 1 + c^2 } - cp } \right) $
\end{flushright} \par
\[ N^+(p) = \frac{1}{ c + \sqrt{ 1 + c^2 } } \cdot \frac{1}{1+p} \]
\item $ W^*(p) = \frac{ N^+ (p) }{ \psi (p) } = \frac{1}{ c + \sqrt{ 1 + c^2 } } \cdot \frac{1}{1+p} \cdot \frac{1+p}{ cp + \sqrt{ 1 + c^2 } } = \cfrac{ \left. \cfrac{1}{ c \sqrt{ 1 + c^2 } + 1 + c^2 } \right\} k^* }{ \underbrace{ \cfrac{c}{ \sqrt{ 1 + c^2 } } }_{T^*} p + 1 } $
\end{enumerate}
\end{problem}
