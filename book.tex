...
\begin{tikzpicture}	
	...
	\node[block] (block2_1) [below = 10.5em of input_int] {$ B $};
	...
	\node[block] (block1_2)[right = 1em of sum1_1] {$\in$};	
	
	\node[block] (block1_3)[below = 1em of block1_2] {$A$};
	
	\node[block] (block1_4)[right = 1em of block1_2] {$C$};	
	
	
	
	
	\mysum{right = 1em of block2_1}{sum2_1};
	\node[block] (block2_3)[above = 2em of block2_1] {$\left( D-GC \right)\left( A{{L}
	_{1}}-A{{L}_{2}}G \right)$ };
	\node[block] (block2_2)[below = 2em of block2_3] {$\in$};	
