...
\begin{multline*}
S_\rho ( \omega ) = 25 \left( \,\, \int\limits_{ -\infty }^{0} e^{ 0.4\tau } e^{ -j\omega\tau } d\tau + \int\limits_{0}^{ \infty } e^{ -0.4\tau } e^{ -j\omega\tau } d\tau \right) = \\ 25\left( \int\limits_{-\infty }^{0}{\exp \left( 0.4j\omega \tau  \right)d\tau +\int\limits_{0}^{+\infty }{\exp \left( -0.4-j\omega  \right)\tau d\tau }} \right)=
